...
class Metadata {
  ...
  Metadata.fromJson(dynamic json) {
    _currentOffset = json['currentOffset']as int;
    _totalCount = json['totalCount']as int;
  }
  int? _currentOffset;
  int? _totalCount;
...
class Data {
  ...
  Data.fromJson(dynamic json) {
    _id = json['id']as int?;
    _wikiDataId = json['wikiDataId']as String?;
    _type = json['type']as String?;
    _city = json['city']as String?;
    _name = json['name']as String?;
    _country = json['country']as String?;
    _countryCode = json['countryCode']as String?;
    _region = json['region']as String?;
    _regionCode = json['regionCode']as String?;
    _latitude = json['latitude']as double?;
    _longitude = json['longitude']as double?;
    _population = json['population']as int?;
  }
  int? _id;
  String? _wikiDataId;
  String? _type;
