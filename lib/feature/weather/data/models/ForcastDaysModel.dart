...
class Alerts {
  ...
  Alerts.fromJson(dynamic json) {
    _senderName = json['sender_name'] as String?;
    _event = json['event'] as String?;
    _start = json['start'] as int?;
    _end = json['end'] as int?;
    _description = json['description'] as String?;
    _tags = json['tags'] as List<String> != null
...
class Daily {
  ...
  Daily.fromJson(dynamic json) {
    ...
    _moonrise = json['moonrise'] as int?;
    _moonset = json['moonset'] as int?;
    _moonPhase = json['moon_phase'] as double?;
    ...
    _dewPoint = json['dew_point'] as double?;

    _windSpeed = json['wind_speed'] as num?;
    _windDeg = json['wind_deg'] as int?;
    _windGust = json['wind_gust'] as double?;
...
class Feels_like {
  ...
  Feels_like.fromJson(dynamic json) {
    ...
    _night = json['night'] as num?;
    _eve = json['eve'] as double?;
    _morn = json['morn'] as double?;
  }
  double? _day;
  num? _night;
  double? _eve;
...
class Temp {
  ...
  Temp.fromJson(dynamic json) {
    _day = json['day'] as double?;
    _min = json['min']as double?;
    _max = json['max']as num;
    _night = json['night']as double?;
    _eve = json['eve']as double?;
    _morn = json['morn']as double?;
  }
  double? _day;
...
class Current {
  ...
  Current.fromJson(dynamic json) {
    ...
    _humidity = json['humidity']as int?;
    _dewPoint = json['dew_point']as double?;
    _uvi = json['uvi']as num?;
    _clouds = json['clouds']as int?;
    _visibility = json['visibility']as int?;

    _windSpeed = json['wind_speed']as double?;
    _windDeg = json['wind_deg']as int?;
